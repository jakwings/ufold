...
"\n"
"                When the flag --spaces (-s) is given and a fragment containing"
                 " no spaces exceeds the maximum width, the program will still"
                 " insert a hard break inside the text.\n"
"\n"
